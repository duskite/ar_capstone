 ...
 */
package com.mju.ar_capstone.rendering;
...
public class PlaneRenderer {
  private static final String TAG = com.mju.ar_capstone.rendering.PlaneRenderer.class.getSimpleName();
  ...
  public void createOnGlThread(Context context, String gridDistanceTextureName) throws IOException {
    int vertexShader =
            com.mju.ar_capstone.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
    int passthroughShader =
            com.mju.ar_capstone.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Program creation");
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Texture loading");
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
  }
  ...
  private void draw(float[] cameraView, float[] cameraPerspective, float[] planeNormal) {
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Drawing plane");
  }
  ...
  public void drawPlanes(Collection<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective) {
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Setting up to draw planes");
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "Cleaning up after drawing planes");
  }
