...
public class ObjectRenderer {
  private static final String TAG = com.mju.ar_capstone.rendering.BackgroundRenderer.class.getSimpleName();
  /**
   * Blend mode.
   *
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "OBJ buffer load");
  ...
  public void draw(
    ...
    com.mju.ar_capstone.rendering.ShaderUtil.checkGLError(TAG, "After draw");
  }
